...
def run_experiment(
    ...
    encoder_config["layer_input_dim"] = get_tensor_dict_input_layer_dim(
        train_data)
    encoder_config["output_input_dim"] = get_tensor_dict_output_layer_dim(
        train_data)
...
def main(
    ...
    encoder = (f"AV-L{layer_encoder_layers}-H{layer_encoder_dim}-"
               f"-RNN-H{encoder_rnn_dim}")
