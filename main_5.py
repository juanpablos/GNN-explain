...
from src.data.utils import (
    get_tensor_dict_input_layer_dim,
    get_tensor_dict_output_layer_dim,
    train_test_dataset,
)
...
from src.typing import GNNEncoderModelConfig, LSTMConfig, NetworkDataConfig
...
def run_experiment(
    encoder_config: GNNEncoderModelConfig,
    ...
    encoder_config["layer_input_dim"] = get_tensor_dict_input_layer_dim(train_data)
    encoder_config["output_input_dim"] = get_tensor_dict_output_layer_dim(train_data)
    ...
    trainer = TensorDictSequenceTrainer(
        seed=seed,
        subset_size=0.2,
...
def main(
    ...
    layer_encoder_layers = 2
    layer_encoder_dim = 128
    encoder_rnn_dim = 128
    encoder_output = 1024
    merge_strategy = "cat"
    encoder_config: GNNEncoderModelConfig = {
        "layer_input_dim": None,
        "output_input_dim": None,
        "encoder_num_layers": layer_encoder_layers,
        "encoder_hidden_dim": layer_encoder_dim,
        "layer_embedding_dim": encoder_rnn_dim,
    ...
    data_config: NetworkDataConfig = {
        ...
        "load_aggregated": "gnns_tensor_dict.pt",
    ...
    encoder = (
        f"AV-L{layer_encoder_layers}-H{layer_encoder_dim}-" f"-RNN-H{encoder_rnn_dim}"
    )
